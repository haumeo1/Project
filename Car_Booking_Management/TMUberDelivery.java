...
public class TMUberDelivery extends TMUberService
{
  ...
  public boolean equals(Object other)
  {
    ...
    TMUberDelivery temoTmUberDelivery = (TMUberDelivery)other;
    // If this and other are deliveries, check to see if they are equal

    if(!(super.equals(other)&&this.getFoodOrderId().equals(temoTmUberDelivery.getFoodOrderId()) && this.getRestaurant().equals(temoTmUberDelivery.getRestaurant()))){
      return false;
    }
    return true;
  }
