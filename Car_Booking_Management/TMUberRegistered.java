...
public class TMUberRegistered
{
    ...
    private static int firstXLDriverId = 800;
    ...
    public static String generateXLDriverId(ArrayList<XLDriver> current){
        
        return ""+firstXLDriverId+current.size();
    }
    ...
    // Register 2 xlDriver
    public static void loadPreregisteredXLDrivers(ArrayList<XLDriver> xlDrivers){
        xlDrivers.add(new XLDriver(generateXLDriverId(xlDrivers), "Tom Hank", "RAM", "JUNGLE",3));
        xlDrivers.add(new XLDriver(generateXLDriverId(xlDrivers), "John Cena", "Ford 150", "WWEEEE",6));
